            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildDeliveryCard(context,
                    'assets/checkOut/icon${index + 1}.png', 'UGX 4,000', '1-2');
              },
            ),
          ),
        ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Kikoni, Makerere, Kampala, Uganda',
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('UGX 250,000', style: FontStyles.montserratSemiBold14()),
              ],
            ),
          ),
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('UGX 4,000', style: FontStyles.montserratSemiBold14()),
              ],
            ),
          ),
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('UGX 254,000', style: FontStyles.montserratBold19()),
              ],
            ),
          ),
          Container(
